...
class StartBtn extends Container {
	constructor(scene: Phaser.Scene, x = 0, y = 0) {
		...
		var t = this;
		(this.hitArea = new Phaser.GameObjects.Rectangle(scene,0,50,i.GAME_WIDTH,i.GAME_HEIGHT - 170));
		var o = new Texture(scene.textures, frameKey, (texture.source[0] as any).source);
		o.add('__BASE', 0, cutX, cutY, width, height);
		return o.baseTexture.scaleMode = Phaser.ScaleModes.NEAREST,
	...
	onOver() {
		this.img.scaleX = 1.05,
		this.img.scaleY = 1.05
	}
