...
class NextButton extends Container
{
    ...
    constructor(scene: Phaser.Scene, x = 0, y = 0) {
        ...
        return t.actionText = scene.add.text(0, 0, '', textStyle),
...
export default class AdvScene extends Scene
{
    ...
    create()
    {
        ...
        this.endingFlg = !1,
        5 == D.stageId ? this.endingFlg = !0 : 4 == D.stageId ? (AudioManager.play("voice_thankyou"),
    ...
    nextPart() {
        ...
        this.resourceBgKey = "advBg" + this.senario[this.stageKey].part[this.partNum].background + ".gif",
        this.bgSprite.setTexture('game_ui', this.resourceBgKey),
        "advBgDone.gif" == this.resourceBgKey && AudioManager.play("g_adbenture_voice0"),
        this.nextBtn.visible = !1,
    ...
    sceneRemoved() {
        ...
        super.sceneRemoved(),
        this.endingFlg ? this.scene.start('gameover-scene') : this.scene.start('game-scene');
    }
}