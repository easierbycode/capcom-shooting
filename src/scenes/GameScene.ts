...
export default class GameScene extends Scene
{
    ...
    init()
    {
        ...
        this.itemTextureList.powerupBig = [PIXI.Texture.fromFrame("powerupBig0.gif"), PIXI.Texture.fromFrame("powerupBig1.gif")],
        this.itemTextureList.powerup3way = [PIXI.Texture.fromFrame("powerup3way0.gif"), PIXI.Texture.fromFrame("powerup3way1.gif")],
        this.itemTextureList.barrier = [PIXI.Texture.fromFrame("barrierItem0.gif"), PIXI.Texture.fromFrame("barrierItem1.gif")],
        this.itemTextureList.speedup = [PIXI.Texture.fromFrame("speedupItem0.gif"), PIXI.Texture.fromFrame("speedupItem1.gif")];
        // for (var u = [], c = 0; c < 5; c++) {
        //     var f = [];
...
var y = function(t) {
    function e(t, o) {
        ...
        i.character = new PIXI.extras.AnimatedSprite(window.gameScene, t, 'game_asset'),
        ...
        i.unit.hitArea = new PIXI.Rectangle(window.gameScene, 0, 0, i.character.width, i.character.height),
        i.shadowOffsetY = 0,
        // i.shadow = new PIXI.extras.AnimatedSprite(t),
        i.shadow = new PIXI.extras.AnimatedSprite(window.gameScene, t, 'game_asset'),
        i.shadow.animationSpeed = .1,
        i.shadow.tint = 0,
        i.shadow.alpha = .5,
        void 0 !== o) {
            // i.explosion = new PIXI.extras.AnimatedSprite(o);
            i.explosion = new PIXI.extras.AnimatedSprite(window.gameScene, o, 'game_asset');
            var n = (i.unit.height + 50) / i.explosion.height;
            n >= 1 && (n = 1),
            // i.explosion.scale.set(n + .2),
            i.explosion.setScale(n + .2),
    ...
    function e(t) {
        ...
        "object" !== C(t.texture[0])) {
            for (var n = 0; n < t.texture.length; n++) {
                ...
                (a = PIXI.Texture.fromFrame(t.texture[n])),
                t.texture[n] = a
            }
        ...
        o.unit.hitArea = new PIXI.Rectangle(window.gameScene, 7, 20, o.unit.width - 14, o.unit.height - 40),
